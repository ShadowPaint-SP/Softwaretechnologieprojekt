...
|[[{base_customer}]]{base_customer}    |Eine authentifizierte Person; eine Person welche eingeloggt in einem Account ist
|[[{base_employee}]]{base_employee}    |Eine vom {campsite} angestellte Person; eine Person welche eingeloggt ist in einem Account, welcher als Mitarbeiter markiert ist
|[[{base_boss}]]{base_boss}            |Der Besitzer vom {campsite}; eine Person welche eingeloggt ist in einem Account, welcher als Boss markiert ist
