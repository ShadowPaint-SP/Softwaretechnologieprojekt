...
|Attatchment +
(_Attatchment_)     |Ein Attatchment welches dazu gebucht werden kann
|Auto Parkplatz + 
...
|Ergebnis     a|
- Das Sportgerät wird auf der {glossar_website} als ausgeliehen angezeigt
|===
