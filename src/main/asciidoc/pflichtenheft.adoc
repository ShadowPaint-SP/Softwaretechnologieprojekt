...
|Registirerter Nutzer +
(_Registered User_)   | um customer zu werden, muss sich der User registrieren und wird im System als Registered User mit geringsten privilegien angelegt
