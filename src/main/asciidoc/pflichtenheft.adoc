...
Der Besitzer des Campingplatzes Below-The-Sun hat die Gruppe sechs damit beauftragt, eine Software zu entwickeln. Der
Platz wächst stetig und ist gut besucht, doch es besteht ein starker Personalmangel. Der Besitzer erhofft sich
...
Below-The-Sun hat eine gewisse Anzahl von verschieden dimensionierten Stellplätzen.
...
vom Personal (_Employee_) offiziell eingecheckt und erhält den gewünschten Stellplatz automatisch zugewiesen bzw.
entsprechend seiner Reservierung. <- hääää  +
