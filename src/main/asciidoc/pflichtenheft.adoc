...
|Beschreibung               |Ein benutzer soll sich in auf der Webseite einen Account erstellen können, dort einloggen können und sich auch ausloggen können
...
1. {glossar_user} drückt "{navigate_logout}" in der Navigationsleiste
