...
public interface ReservationRepository<U extends Product> extends CrudRepository<Reservation<U>, UUID> {
     ...
     */
    @Override
    List<Reservation<U>> findAll();

    /**
     * Returns a List of Reservations with a given UserId.
     * Implementation auto generated by Java Spring
     */
    List<Reservation<U>> findByUserId(UserAccount.UserAccountIdentifier id);
    ...
    @Query("""
            ...
            """)
    List<Reservation<U>> findReservationsBetween(LocalDateTime arrival, LocalDateTime departure);
