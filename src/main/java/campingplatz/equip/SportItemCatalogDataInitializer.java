...
public class SportItemCatalogDataInitializer implements DataInitializer {
	...
	public void initialize() {
		sportItemCatalog.save(new SportItem("Fußball", Money.of(0.5, EURO), Money.of(16, EURO), "Ball", 10));
		sportItemCatalog.save(new SportItem("Basketball", Money.of(0.5, EURO), Money.of(20, EURO), "Ball", 8));
		sportItemCatalog.save(new SportItem("Federballset", Money.of(1, EURO), Money.of(30, EURO), "Federball", 3));
		sportItemCatalog.save(new SportItem("Tischtennisgarnituren",
			Money.of(2, EURO), Money.of(100, EURO), "Tischtennis", 2));
