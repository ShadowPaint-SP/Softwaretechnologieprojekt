...
public class SportItemReservationController {
	...
	SportItemReservationController(SportItemReservationRepository reservationRepositorySportItem,
			SportItemCatalog itemCatalog) {
	...
	String cart(Model model,
		...
		if (startTime.isBefore(currentDate) || endTime.isBefore(startTime)
