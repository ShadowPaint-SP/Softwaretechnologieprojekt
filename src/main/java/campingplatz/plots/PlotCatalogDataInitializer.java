...
class PlotCatalogDataInitializer implements DataInitializer {
    ...
    public void initialize() {
		...
		plotCatalog.save(new SeasonalPlots("1. Saison Plot", 50.0, Money.of(100, EURO), Plot.ParkingLot.SEASONAL_CAMPING, 0, 0, "hans", SeasonalPlots.PaymentMethod.SEASONAL));
		plotCatalog.save(new SeasonalPlots("2. Saison Plot", 30.0, Money.of(80, EURO), Plot.ParkingLot.SEASONAL_CAMPING, 200, 533, "hans", SeasonalPlots.PaymentMethod.SEASONAL));
		plotCatalog.save(new SeasonalPlots("2. Saison Plot", 120.0, Money.of(150, EURO), Plot.ParkingLot.SEASONAL_CAMPING, 232932, 334883, "hans", SeasonalPlots.PaymentMethod.SEASONAL));
	}
}
