...
public class SeasonalPlot extends Plot {
	...
	public Double settlementElectricity(double electricityMeter) { // returns the electricity difference for this
		// time period
	...
	public Double settlementWater(double waterMeter) { // returns the water differnce for this time period
